...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		//获取自定义属性和默认值
		roundColor = resources.getColor(R.color.white);
		roundProgressColor = resources.getColor(R.color.tab_blue);
		textColor = resources.getColor(R.color.white);
		textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize, 1);
